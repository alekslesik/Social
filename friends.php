...
if (sizeof($followers)) {
    echo "<span class='subhead'>$name2 mutual followers</span></ul>";
...
if (sizeof($following)) {
    echo "<span class='subhead'>$name3 mutual following</span></ul>";
    foreach ($following as $friend)
        echo "<li><a data-transition='slide' href='members.php?view=$friend'></a>";
    echo "</ul>";
    $friends = TRUE;
}
